...
const sections = [
    ...
    {
        title: "How can I create effective Nano Vido Prompt?",
        text:
    ...
    {
        title: "Is Vido Prompt free to use?",
        text:
            "Yes for prompts. Browsing and sharing prompts is free. Generating images in the Studio uses paid credits. Some paid plans include access to curated premium prompts authored by Vido Prompt (admins).",
    },
    {
    ...
    {
        title: "What are popular prompt categories on Vido Prompt?",
        text:
    ...
    },
    {
        ...
        text:
            "Nano Banana delivers photorealistic, aesthetic-first results with fast generation and tight integration inside Google's ecosystem. Midjourney is known for painterly, community-driven styles; Stable Diffusion is open-source and endlessly tweakable; DALL-E (via ChatGPT) excels at surreal concepts; Leonardo, Firefly, and Ideogram cover advanced editing, brand-safe outputs, or precise typography. Vido Prompt helps you swap prompts among them to learn what each does best.",
    },
    {
        title: "Can I adapt Vido Prompt for other AI models?",
        text:
            "Absolutely. Every prompt can be tuned for ChatGPT image tools, DALL-E, Midjourney, Stable Diffusion, Leonardo, Adobe Firefly, Ideogram, Craiyon, and more. Adjust descriptors to suit each model's strengths—Vido Prompt provides the starting point, you decide the destination.",
    },
];
        ...
        <>
            ...
            <main className="terms-page container">
                ...
                <section className="terms-hero">
                    ...
                    <h1>
                        Everything you need to know about Vido Prompt & Nano Vido Prompt. <br />
                    </h1>
